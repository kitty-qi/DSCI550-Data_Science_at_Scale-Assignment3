...
## geolocation and users' genders in each location`
)}
...
FileAttachment("sample@6.json").json()
)}
...
md`### reference: https://observablehq.com/@d3/zoomable-sunburst`
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["sample@6.json", {url: new URL("./files/geolocation_gender.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
