...
(function() {
    ...
    */
    ...
    function render(classd, spaced, data, enableBrush) {
        ...
        var height = (lessThanDay(padding.pad)) ? (300 - margin.top - margin.bottom) : (500 - margin.top - margin.bottom);
        ...
        if (enableBrush) {
            ...
            window.document.getElementById(classd).insertAdjacentHTML('beforeend', brushEl);
